...
\____/| .__/ \__,_|_| |_| |_| \____/|_| |_| |_|___/
      | |                                          
      |_|  '''+W+'Creator : Server 048 : Bagus anggara')
	...
	def AlfaMart(Phone, Amount):
		for _ in range(Amount):
			...
			'email' : 'Pandahacker048@gmail.com',
			'password' : 'Kontol',
			'isNewsletter' : 'on'
			}
			...
			postData = Sess.post('https://www.alfacart.com/getMemberInfo', data = {'email' : 'Pandahacker048@gmail.com'})
			postData_2 = Sess.post('https://www.alfacart.com/otp/checkActiveNumber', data = {'phoneNumber' : Phone, 'email' : 'pandahacker048@gmail.com'})
	...
	def Spam():
		...
		if PilihTools == '1':
			...
			os.system('xdg-open https://wa.me/6282246699937?text=Sayang-ada-Bag')
...
if __name__ == '__main__':
	print(C+'Folow My Instagram Tod ')
	sleep(3)
	os.system('clear')
	os.system('xdg-open https://instagram.com/bagus_1129xo?igshid=js9mv6w7lihy')
	sleep(7)
	Spam()
